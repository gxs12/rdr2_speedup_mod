...
IMPORT void scriptRegister(HMODULE hmodule, void(*LP_SCRIPT_MAIN)());
IMPORT void scriptRegisterAdditionalThread(HMODULE hmodule, void(*LP_SCRIPT_MAIN)());
IMPORT void scriptUnregister(HMODULE hmodule);
